...
function LoanRequest() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/admin/loans`, {
                    headers: {
    ...
    const onConfirm = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/admin/delete-loan/${depositId}`, {
                headers: {
                    Authorization: `Bearer ${user.token}`
                }
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/admin/loan/${depositId}`, {
                        ...
                        <table className='equal-table'>
                            ...
                            <tbody>
                                {data.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="9" className="no-loan-message">No Loan Requests</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
